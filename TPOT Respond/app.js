...
// var searchResults = []
// var index;
// var extentionURL = chrome.extension.getURL('index.json');

// console.log(extentionURL);
...
//     }
//   }
//   xmlhttp.open("GET", "https://chrome://extensions/?id=bcanpjpgfepecclheljfgmcoglhchiig/index.json", true);
//   // xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
//   // xmlhttp.send("x=" + index);
//   xmlhttp.send();
// }
...
// for (var p = 0; p < data.papers.length; p++) {
//   var match = false;
//   var chars = data.papers[p].tags
//   var tags = chars.match(/[a-z,]+($|\s+)/gi);
//   for (var t = 0; t < tags.length && tags.length != 0; t++) {
//     tags[t] = tags[t].replace(/^\s+|\s+$|[,]|\s+(?=\s)/g, "");
//   }
//   var ping = 0;
//   for (var t = 0; t < tags.length; t++) {
//     for (var k = 0; k < keywords.length; k++) {
//       if (tags[t] === keywords[k]) {
//         ping++;
//       }
//     }
//   }
//   console.log(ping, chars, tags);
//
// }



// Key Keywords within Search Bar
